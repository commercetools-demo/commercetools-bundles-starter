...
import { TProductVariant } from '../../types/generated/ctp';
...
const StaticBundlesTable = () => {
  ...
  function renderItem(row, columnKey) {
    const bundle = row;
    const masterVariant: TProductVariant = bundle.masterVariant;
    ...
    switch (columnKey) {
      ...
      case COLUMN_KEYS.PRODUCTS: {
        //masterVariant.attributes is fine here since this is an object loaded via rest
        // @ts-ignore
